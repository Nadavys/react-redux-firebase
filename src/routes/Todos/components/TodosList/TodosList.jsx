...
import { TODOS_COLLECTION } from 'constants/firebasePaths'
...
function useProjectsList() {
  ...
  const projects = useSelector(({ firestore: { ordered } }) => ordered.todos)
